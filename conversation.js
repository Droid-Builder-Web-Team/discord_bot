	...
	identify: (message, client) => {
		...
		const questionHookReplies = {
			...
			'anything new': [
				...
				'No, I\'m still searching for replacement booster parts. They have been off the market for decades now, and I want to fly!',
				'Yes, actually! Master Luke says we are going to pick up a new padawan that looks like Master Yoda! I hope he doesn\'t carry a stick! https://media.giphy.com/media/3ornkfSSqEK5YK7N7y/giphy.gif'
			],
			'it was a joke|take a joke|was only a joke': [
				...
				'https://media.giphy.com/media/LOj3XYmCCYxATNVSKj/giphy.gif',
				'https://media.giphy.com/media/26zz7sVuN5xNNs0BW/giphy.gif',
				'https://media.giphy.com/media/kGweWfIbaezO8/giphy.gif',
				'How is that a joke? It wasn\'t very funny.',
				'A joke? I have a joke for you... knock knock',
			...
			'show me t3|show t3|what is a t3': ['What\'s a T3?', 'Do you mean the three things shown in Total Recall? I can\'t show you those here!', 'https://static.wikia.nocookie.net/starwars/images/f/fb/T3-M4-promo.jpg/revision/latest/scale-to-width-down/500?cb=20100121131618']
		};
